...
insert into Locations(contactPerson,phoneNumber,addr,city,distId) values('Jason','9191234567','2200, A Street, NC','charlotte',2001);

insert into Distributors values(2002,'BookDist','wholesaler',0,'9291234567');
insert into Locations(contactPerson,phoneNumber,addr,city,distId) values('Alex','9291234567','2200, B Street, NC','Raleigh',2002);
...
insert into Payrolls(cmId,amount,paymentDate,claimDate) values (3001,1000,'2020-04-01',NULL);
...
insert into Payrolls(cmId,amount,paymentDate,claimDate) values (3002,1000,'2020-04-01',NULL);
...
insert into Payrolls(cmId,amount,paymentDate,claimDate) values (3003,1200,'2020-04-01',NULL);
...
insert into Bills(billAmt,generationDate,receiptDate,distId) values(630,'2020-01-02','2020-01-02',2001);
insert into OrderBillMappings(orderId,billId) values (4001,1);

insert into Bills(billAmt,generationDate,receiptDate,distId) values(215,'2020-02-05',NULL,2001);
insert into OrderBillMappings(orderId,billId) values (4002,2);

insert into Bills(billAmt,generationDate,receiptDate,distId) values(115,'2020-02-10','2020-02-10',2002);
